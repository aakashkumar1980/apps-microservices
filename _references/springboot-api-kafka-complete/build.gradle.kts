...
dependencies {
    ...
    implementation("com.github.java-json-tools:json-schema-core:$jsonSchemaValidationCore") {
        exclude(group = "org.slf4j")
    }
    implementation("com.github.fge:json-schema-validator:$jsonSchemaValidationVersion") {
        exclude(group = "org.slf4j")
    }
